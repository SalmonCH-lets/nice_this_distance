...
// Load default pattern from base64 & load local font/極太明朝.ttf
async function loadDefaultAssets() {
  try {
    ...
    console.warn('Local font load notice:', fontErr);
  }
  ...
  try {
    ...
    console.warn('Pattern image load fallback', err);
...
function bindEvents() {
  ...
  // Downloads
  elements.downloadCompositeBtn.addEventListener('click', downloadCompositePhoto);
  elements.downloadTransparentBtn.addEventListener('click', downloadTransparentTelop);
